...
for (cancer_type in cancer_types) {
  ...
  output_base <- file.path("/path/to/project/results", cancer_type, "03.coverage")
  output_dir <- file.path("/path/to/project/results", cancer_type, "04.activity")
  ...
  Reference_length_dir <- file.path("/path/to/project/data/reference", reflist)
