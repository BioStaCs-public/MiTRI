...
output_base <- file.path("/path/to/project/results/special", cancer_type, "06.coverage_target")
output_dir  <- file.path("/path/to/project/results/special", cancer_type, "04.activity_region_T_Nback")
dir.create(output_dir, recursive = TRUE)

reference_base <- file.path("/path/to/project/data/reference")
reference_length_csv <- file.path("/path/to/project/data/csvs_special", reflist)
reference_lengths <- fread(reference_length_csv, colClasses = list(numeric = "Reference_length"))

control_base <- "/path/to/project/results/control"
...
normal_dir_base <- "/path/to/project/results/cancers/PROJECT/03.coverage/Normal"
